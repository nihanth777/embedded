...
void MFRC522::setSPIConfig() {
  //cout <<"here madarchod" << endl;
  bcm2835_spi_begin();
  //cout <<"here madarcho1d" << endl;
  bcm2835_spi_setBitOrder(BCM2835_SPI_BIT_ORDER_MSBFIRST);
  //cout <<"here madarchod2" << endl;      // The default
  bcm2835_spi_setDataMode(BCM2835_SPI_MODE0);                   // The default
  //cout <<"here madarchod3" << endl;
  bcm2835_spi_setClockDivider(BCM2835_SPI_CLOCK_DIVIDER_64);    // ~ 4 MHz
  //cout <<"here madarchod5" << endl;
  bcm2835_spi_chipSelect(BCM2835_SPI_CS0);                      // The default
  //cout <<"here madarchod6" << endl;
